...
class Groups extends Admin_Controller 
{
	...
	public function create()
	{
		...
		$this->data['js'] = 'application/views/groups/create-js.php';
	...
	public function edit($id = null)
	{
		...
		$this->data['js'] = 'application/views/groups/edit-js.php';
		if($id) {
	...
	public function delete($id)
	{
        ...
        $this->data['js'] = 'application/views/groups/delete-js.php';
		if($id) {
